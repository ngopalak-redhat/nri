...
func (pv *PolicyBasedValidator) ValidateContainerAdjustment(ctx context.Context, req *api.ValidateContainerAdjustmentRequest, validationCtx *ValidationContext) error {
	pod := req.GetPod()
	if pod == nil {
...
func (ev *ExtendedValidator) ValidateContainerAdjustment(ctx context.Context, req *api.ValidateContainerAdjustmentRequest, validationCtx *ValidationContext) error {
