...
func (rv *RestrictionsValidator) ValidateContainerAdjustment(req *api.ValidateContainerAdjustmentRequest) error {
	pod := req.GetPod()
	if pod == nil {
...
func (rv *RestrictionsValidator) validatePluginMutations(pluginName string, req *api.ValidateContainerAdjustmentRequest) error {
...
func (rv *RestrictionsValidator) validatePodAccess(pluginName string, pod *api.PodSandbox) error {
...
func (rv *RestrictionsValidator) extractMutationCapabilities(adjust *api.ContainerAdjustment) []MutationCapability {
	if adjust == nil {
		return nil
	}
...
func (rv *RestrictionsValidator) checkPodRestriction(restriction PodRestriction, pod *api.PodSandbox) error {
...
func (rv *RestrictionsValidator) podMatches(selector PodSelector, pod *api.PodSandbox) bool {
	// Check namespace
